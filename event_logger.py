...
class EventList:
    ...
    Instance Attributes:
        - first: First event in the LinkedList, none if the list is empty
        - last: Last event in the LinkedList, none if the list is empty

    Representation Invariants:
        - self.last is None if self.first is None
    """
